...
# Editar src/config/firebase.ts con tus credenciales
...
El proyecto utiliza Firebase directamente configurado en `src/config/firebase.ts`. Para producción, se recomienda mover las credenciales a variables de entorno.
