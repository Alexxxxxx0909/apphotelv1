...
export const ManagerForm: React.FC<ManagerFormProps> = ({
  ...
  const { hotels } = useHotels(); // Obtener todos los hoteles sin filtro
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label>Seleccionar hoteles (sucursales) *</Label>
              {hotels.length > 0 ? (
              ...
              <p className="text-xs text-muted-foreground">
                Seleccione uno o más hoteles/sucursales para asignar al gerente
              </p>
            </div>
          </div>
        </CardContent>
